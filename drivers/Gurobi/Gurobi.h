...
public:
 ...
 EIGEN_GUROBI_API int threads() const;
 EIGEN_GUROBI_API void threads(int tol);

	EIGEN_GUROBI_API const VectorXd& result() const;
 EIGEN_GUROBI_API const VectorXd& dualEqResult() const;
 EIGEN_GUROBI_API const VectorXd& dualIneqResult() const;
